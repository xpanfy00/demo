...
public class ImageUploadService {
    ...
    public ImageModel uploadImageToUser(MultipartFile file, Principal principal) throws IOException {
        ...
        ImageModel userPrfileImage = imageRepository.findByUserId(user.getId()).orElse(null);
        if (!ObjectUtils.isEmpty(userPrfileImage)) {
            imageRepository.delete(userPrfileImage);
        }
    ...
    public ImageModel getImageToUser(Principal principal) {
        ...
        ImageModel imageModel = imageRepository.findByPostId(user.getId()).orElse(null);
